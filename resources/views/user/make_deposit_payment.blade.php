                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-6">
                        <div class="page-title-content">
                            <h3>Deposit Payment Page</h3>
                            <p class="mb-2">Welcome ENFTX Deposit Payment page</p>
                        </div>
                    </div>
                    <div class="col-auto">
                        <div class="breadcrumbs"><a href="#">Deposit Payment </a><span><i
                ...
                <div class="col-xxl-4 col-xl-12">
                    <div class="card welcome-profile">
                        <div class="card-body"><img src="images/avatar/1.jpg" alt="">
                            <p>You are required to copy the any of the crypto currency Wallet Address below to make a deposit, and <br>
                            ...
                            <div class="row"
                                style="background-color: #030b21; padding:10px 10px;margin:0px 5px; border-radius:10px;">
                                <div class="col-md-4">
                                    <h3 style="color: #00ffa3;">BTC WALLET ADDRESS:</h3>
                                </div>
                            ...
                            <div class="row"
                                style="background-color: #030b21; padding:10px 10px;margin:0px 5px; border-radius:10px;">
                                <div class="col-md-4">
                                    <h3 style="color: #00ffa3;">USDT WALLET ADDRESS:</h3>
                                </div>
                            ...
                            <div class="text-end">
                                ...
                                <a class="btn btn-primary" href="{{ route('deposit.successful') }}">I've Paid</a>
                            </div>
